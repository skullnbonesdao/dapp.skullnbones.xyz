import{au as o,ah as d,b1 as i,ak as l,as as p,Z as _,V as c,c_ as r,al as h}from"./index.fea96a80.js";function b(e,a=2,n=3){e||(e=0);const t=e.toFixed(a).split(".");return t[0]=t[0].padStart(n,"0"),t.join(".")}const g=["innerHTML"],x=o({__name:"FormatNumber",props:["number","decimals","padStart"],setup(e){const a=e,n=d(()=>{const t=/^(0+)(.+)/,s=b(a.number,a.decimals,a.padStart).match(t);if(s){const u=s[1],m=s[2];return`
          <div class="row" >
